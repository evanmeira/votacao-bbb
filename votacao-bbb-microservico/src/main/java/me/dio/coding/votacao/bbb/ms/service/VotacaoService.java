...
public class VotacaoService {
    ...
    private void executar(ConsumerRecord<String, String> registro){
        ...
        try {
            ...
            log.error("Falha ao converter voto [{}]", participante, e);
            return;
        }

        VotacaoModel votacao = new VotacaoModel(null, new Date(), participante);
        VotacaoModel entity = votacaoRepository.save(votacao);
